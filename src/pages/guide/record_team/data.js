...
@connect(({ guidance_team, loading }) => ({
  guidance_team,
  loading: loading.models.guidance_team,
}))
@Form.create()
class guide extends PureComponent {
  ...
  columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <Fragment>
          <Link to={`${rc}/guide/record_team/user?id=${record.id}`}>
            详情
          </Link>
        </Fragment>
      ),
