...
class chufang extends PureComponent {
  ...
  getGuide(){
    this.props.dispatch({
      type: 'guide_tice_all/chufang_guide_search',
      payload: {
        sportReportId:this.state.sportReportId,
  ...
  handleOKGuide = () => {
    ...
    const { dispatch } = this.props;
    dispatch({
      type: 'guide_tice_all/chufang_guide',
      payload: params,
      callback: res => {
        if(res.code == 200){
          this.setState({
      ...
      return (
        <div className={styles.page}>
          <div className={styles.container}>
            ...
            {/* 专家指导意见 */}
            <div style={{margin:'28px 0 10px 0'}}><b>专家指导意见</b></div>
